...
func (g *Game08) Draw(screen *ebiten.Image) {
...
func (g *Game08) printDebugInfo(screen *ebiten.Image) {
...
func (g *Game08) Layout(outsideWidth, outsideHeight int) (screenWidth, screenHeight int) {
