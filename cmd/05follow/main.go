...
func (g *Game05) Draw(screen *ebiten.Image) {
...
func (g *Game05) printDebugInfo(screen *ebiten.Image) {
...
func (g *Game05) Layout(outsideWidth, outsideHeight int) (screenWidth, screenHeight int) {
...
func main() {
	...
	ebiten.SetWindowTitle("05 follow")
